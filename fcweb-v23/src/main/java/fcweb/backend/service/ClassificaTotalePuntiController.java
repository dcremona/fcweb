...
import fcweb.backend.repositories.ClassificaTotalePuntiRepository;
import fcweb.utils.Costants;

@Controller
public class ClassificaTotalePuntiController{

	@Autowired
	private ClassificaTotalePuntiRepository classificaTotalePuntiRepository;

	@RequestMapping(value = "/findAllClassificaTotalePunti", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/findByCampionatoAndAttoreAndGiornataInfo", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/findByFcAttoreAndFcGiornata", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/getModelClassifica", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/getModelGrafico", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/getModelGraficoEm", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(path = "/createem", method = RequestMethod.POST)
	public String createEm(FcAttore attore, FcCampionato campionato ,Double totPunti) {
		String id = "";
		try {
