...
public class EmTeamInsertView extends VerticalLayout
	...
	private void initLayout() throws Exception {
		...
		List<FcCalendarioTim> listPartite = calendarioTimController.findByIdGiornataOrderByDataAsc(giornataInfo.getCodiceGiornata());
	...
	private Grid<FcGiocatore> getTableFormazione(List<FcGiocatore> items) {
		...
		cognGiocatoreColumn.setWidth("210px");
